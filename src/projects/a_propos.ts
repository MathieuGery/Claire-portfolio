export const a_propos = {
    ...
    baseLine: "Curieuse et admirative, je n'hésite pas à exprimer ma créativité avec différentes techniques telles que la linogravure, la sérigraphie, l'art digital, la peinture, le tricot ou encore le crochet.",
    title: "Title",
